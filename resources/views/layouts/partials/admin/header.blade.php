        ...
        <div class="navbar-header" data-logobg="skin6">
            <a class="navbar-brand" href="/admin/dashboard">
                ...
                <span class="logo-text">
                    <h5>
                        <img src="{{ asset('images/logo-trustdland.webp') }}" alt="homepage" style="width: 40px;"
                            class="me-2" />
                        <b class=""> Admin
                            Trustdland </b>
                    </h5>
            ...
            <a class="btn btn-outline-primary btn-sm d-block d-md-none" href="/admin/logout">Logout</a>
