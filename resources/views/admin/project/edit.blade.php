                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="nama_project" type="text"
                                        ...
                                        value="{{ $project->nama_project }}" autocomplete="nama_project" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="lokasi" type="text"
                                        ...
                                        value="{{ $project->lokasi }}" autocomplete="lokasi" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="lat" type="text"
                                        ...
                                        value="{{ $project->lat }}" autocomplete="lat" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="long" type="text"
                                        ...
                                        value="{{ $project->long }}" autocomplete="long" autofocus>
